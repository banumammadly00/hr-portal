...
function CreateEmployee() {
    ...
    const bloodTypeOptions = [
        {value: "ONE", label: 'Bir'},
        {value: "TWO", label: 'İki'},
        {value: "THREE", label: 'Üç'},
        {value: "FOUR", label: 'Dörd'},
    ];
    ...
    const getEmployeeInfo = () => {
        mainAxios({
            ...
            setExpiredIdDate(new Date(data.idcardEndDate));
            ...
            setShowPassport(data.foreignPassportNumber !== '' ? true : false)
            ...
            data.startWorkPermissionDate !== null ? setStartWorkPermissionDate(new Date(data.startWorkPermissionDate)) : setStartWorkPermissionDate(null);
            data.expiredWorkPermissionDate !== null ? setExpiredWorkPermissionDate(new Date(data.expiredWorkPermissionDate)) : setExpiredWorkPermissionDate(null);
    ...
    const getAcademicInfo = () => {
        mainAxios({
            ...
            let data = res.data.data;
            setStartAcademicDegreeDate(new Date(data.academicDegreeDate));
            setAcademicDegreeNumber(data.academicDegreeNumber);
            setShowDegree(data.academicDegreeNumber !=='')
            ...
            setShowEducation(data.higherEducation)
            setShowReward(data.governmentAchievements.length > 0)
            for (let i of educationTypeOptions) {
                if (data.educationType === i.label)
                    setSelectedEducationType(i);
            }

            setShowDriverLicence(data.driverCardCategory !== null)
            ...
            let tmpRewardArr = [];
            for (let i of data.governmentAchievements) {
                let obj = {};
                obj.name = {name: i.name};
                obj.organization = {name: i.organization};
                obj.startDate = i.startDate
                tmpRewardArr.push(obj)
            }
            if (tmpRewardArr.length > 0) {
                setRewardArr(tmpRewardArr);
            }
        });
    }
                                                ...
                                                <Col xs={4}>
                                                    <Form.Group className="form-group">
                                                        ...
                                                        <Form.Label className="relative m-0">
                                                            <DatePicker selected={startIdDate}
